...
- Турагенція / Maslina Resort (Хвар): розбір рілс-сценарію, 3 сценарії з озвучкою, ринок і конкуренти → `projects/maslina-resort/maslina-scenario-review.md` (16.09.2026)
- Вікторія — турагентка, клієнт на рілс про готелі (Maslina, Meneghetti); чат «Монтаж Вікторія», 4 учасники. Скаржиться, коли текст не збігається з кадрами — писати блоками під відео. → `projects/meneghetti/meneghetti-script.md` (22.09.2026)
