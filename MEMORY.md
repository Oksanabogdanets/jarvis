...
- **Стаміна** (@stamina_center) — центр здоров'я спини, Київ. Reels-продюсування. Обличчя: Артем (лікар) + Ілона (співзасновниця). Сценарії в Notion «Стаміна — погоджені теми». Правила — `knowledge/stamina-scripts.md`
...
`knowledge/stamina-scripts.md` — як обробляти надиктовані сценарії Артема (Стаміна). Читати коли Оксана надсилає диктовку російською для Reels.
