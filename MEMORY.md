...
- `knowledge/ai-vydymist-offer.md` — оффер «AI-видимість»: цифри ринку, ціни, склад послуги, доказ на клієнтах. Читати коли працюю над цією послугою або пишу під неї текст.
